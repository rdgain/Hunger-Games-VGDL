package controllers.multiPlayer.RHEA.sampleOLMCTS;
...
public class Agent extends AbstractPlayer {
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        int action = mctsPlayer.run(elapsedTimer, controllers.multiPlayer.RHEA.Agent.SIMULATION_DEPTH, controllers.multiPlayer.RHEA.Agent.MAX_FM_CALLS);
